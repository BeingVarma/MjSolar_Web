...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("highlight-whatsapp", handleHighlight);
  }, []);
        ...
        <div>
          ...
          <div className="mb-12">
            <a 
              ...
              className={`inline-flex w-full sm:w-auto items-center justify-center gap-3 px-8 py-3.5 bg-[#25D366] hover:bg-[#1ebd57] text-white font-bold rounded-full shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_25px_rgba(37,211,102,0.5)] hover:-translate-y-1 transition-all duration-300 ${highlightWhatsApp ? 'animate-pulse ring-4 ring-[#25D366] shadow-[0_0_40px_rgba(37,211,102,0.8)] scale-105' : ''}`}
            >
            ...
            <p className="text-slate-500 text-xs mt-3 text-center sm:text-left sm:ml-4">
              Get a free consultation directly from our solar experts.
            </p>
          </div>

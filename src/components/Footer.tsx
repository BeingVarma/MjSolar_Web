        ...
        <div>
          ...
          <div className="mb-12">
            <a 
              ...
              className="inline-flex w-full sm:w-auto items-center justify-center gap-3 px-8 py-3.5 bg-[#25D366] hover:bg-[#1ebd57] text-white font-bold rounded-full shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_25px_rgba(37,211,102,0.5)] hover:-translate-y-1 transition-all duration-300"
            >
